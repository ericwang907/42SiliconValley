...
I'm replacing the 0s with UNASSIGNED for readability. */
#define UNASSIGNED 0 
...
/* Returns 1 if the specified number already exists in your row.
   0 is given if the number doesn't exist. */
...
/* Returns 1 if the specified number already exists in your column.
   0 is given if the number doesn't exist. */
...
{ 
    ...
    if (!FindUnassignedLocation(grid, &row, &col)) 
       return 1; // This is the end. Sudoku is solved.1 
